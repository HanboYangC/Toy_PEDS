...
class DiffusionModel(nn.Module):
    def __init__(self,input_dim,params,seed=None):
        ...
        self.h3 = nn.Linear(64, params['LF_N'])
        self.LF=LF_Layer(params=params)
    ...
    def forward(self, lengths_list: torch.Tensor, params):
        ...
        x = self.Hardtanh(self.LF(final_D))
        return x
    ...
    def fit(self,learning_rate=1,save_path=None):
        params=self.params
